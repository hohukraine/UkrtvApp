...
Додаток неофіційний та не пов'язаний із сайтами-джерелами контенту.
Він не зберігає відеофайли, а лише показує посилання на публічні сторінки.
Весь контент належить правовласникам. Користувач несе відповідальність за використання.
