...
- **Продовжити перегляд** — прогрес зберігається автоматично. Довге натискання на картку вмикає режим видалення (червоний ✕), натисніть **OK** щоб прибрати запис; на TV це робить кнопка **Menu/Settings**
...
- **Серіали** — по завершенню серії показується лічильник наступної; прогрес і позиція не втрачаються при виході
